...
namespace Proxies\__CG__\Ff\DemoBundle\Entity\Alumnos;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Alumno extends \Ff\DemoBundle\Entity\Alumnos\Alumno implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'apellido', 'nombre', 'dni', 'telefono');
        }
